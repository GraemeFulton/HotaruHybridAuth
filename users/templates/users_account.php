...
<div id="users_account" class="users_content">
    ...
    <tr><td colspan='2'><small><?php echo $h->lang["users_account_username_requirements"]; ?></small></td></tr>
	          ...
	          <?php   require_once(PLUGINS . 'hybridauth/libs/hybridauth_authentication.php'); 
			  $hauth = new authentication();
			  $check = $hauth->social_check($h);
    ...
    <?php }
	    ...
	    <tr><td><input type='hidden' size=30 name='email' value='<?php echo $email_check; ?>' /></td></tr>
