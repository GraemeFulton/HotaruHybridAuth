...
class HybridAuth
{
    ...
    public function settings($h)
    {
        ...
        $hybridauth_application = $hybridauth_settings['application'];
        ...
        if (!$hybridauth_application) { $rpx_application = ''; }
        ...
        echo "<form name='hybridauth_settings_form' action='" . BASEURL . "admin_index.php?page=plugin_settings&amp;plugin=hybridauth' method='post'>\n";
